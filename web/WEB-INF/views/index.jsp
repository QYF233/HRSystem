        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${App_Path}/dept-list">查看部门信息</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a id="login-a" href="${App_Path}/login">登录</a><a id="accName" href="${App_Path}/login" class="hidden" title="点我进入登录页面">${accName}</a></li>
